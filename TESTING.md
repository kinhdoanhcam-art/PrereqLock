...
Tested actor wallet: 0x5a52d040581A76e2C032542855D31480f2ea7097
Historical runtime-suite actor: 0x86895976a0c43A9Be69b1DEd865e9726eE80BA77
Outsider wallet: NOT RECORDED

The current deployment uses the same verified v1.1 source hash as the historical runtime suite below. A fresh canonical happy-path flow was executed against the current address. Historical rows remain evidence for the byte-identical source, but are not represented as current-address transactions.
...
Current canonical end-to-end flow

Execution date: 2026-09-23 UTC.

Gate name: Final submission gate
Gate ID: b8264008b1cfcf5f4e550532dd583307f8e0afecbb0e8d8d922d26263ecf9cde
Rule: Cargo may leave the depot only after the manifest carries a countersignature.
...
FINALIZED, GenVM SUCCESS, consensus Accepted

Gate stored with the expected creator and actor; state LOCKED
...
CONDITION_NECESSARY; edge_installed=true; state ARMED; attempt_count=1
...
condition_met=true; state READY
...
action_done=true; state DONE

The immutable rule log contains one attempt with Rule ID bb36edf83e3c165bdb8e6a8dec2ed85ea390899dcd77b95be6759b4b32521b11, verdict CONDITION_NECESSARY and installs_edge=true. This establishes a fresh positive two-wallet flow for the canonical address; it does not relabel the historical negative tests below as current-address executions.
...
Current StudioNet v1.1 deployment

PASS

Deploy TX 0xb02fd55c9394cdd94dcb6af66364b2a66e94a067db9d66fe43c38299ad0e94e1; FINALIZED, GenVM SUCCESS, consensus Accepted
...
K1-K5 shortcut resistance

PASS

python3 tests/verify_kill_suite.py

Full Unicode pyStrip/pyCollapse parity
...
96fbd9c497aada67fcc9ad0db0e27a6b7faaa342f0449d67b3ae8737e7beda3c
...
c98abff983731c2b56eebf9693e0acc214caabf861ccd2651547debbd2ded328

0x7722aa58b9dcaae217025a0fe926e6981a763bde2fbca7309ea963d90a97f927

0x797f73887b404e40f4ef17c7ee9533b03bda8b931790329c1ca80b710ca06f40
...
0x3ad64786aab21d9b762d6f39c298cc01554a38151c355e7812e6aeb9b51190cc
...
8a231d97d13dbb90d9ba3edfadd7cd4b2f265e072712dd1e69b8c19159855818

0xb0758d4257ccb93489acd07048450df59e83d271ce0bc495cc14441544a430af
...
a22e24021c982af95d78c34bc0972c9d4903e845d8da93e16b4d8cf888f31fcc

0x0a8ec7ec90f6bb4a1dd79fc97f83b54874dbcba882e266fdfc4a870a724748b7

0x187312967074b8e37497b11200d59ad315727bd2cad9560bf14babb0aa758b95
...
Historical deterministic and authorization tests

These tests were run against historical K1 after its accepted state showed ARMED and the semantic transaction had a successful execution result.

Step

Caller

Expected result and postcondition
...
Revert Condition has not been recorded; state remains ARMED

0x59481c73ea98e9aafad52771140347ce731c4b6dbf65ba150d29b914c0a5773c

PASS

Wrong-role condition record

Actor

Revert Only gate creator may record the condition; state unchanged

0xc55105012a6b9838f8dc91586853bb1137ff07002d9d162c130b80c810d70464
...
Success; accepted state is READY, condition_met=true

0x3dff7b3bc5a375b914d7883d606f9292e43dacf6030617cadc7aa15861cc8a29
...
Revert Only gate actor may perform the action; state remains READY

0xa284c1af922a26497b347ffcea4c9a579f6616ea850e56882a1a06d1cff4b68e
...
Same actor-only revert; state unchanged
...
Success; accepted state is DONE, action_done=true

0xff38f70e0fca0d594b7394f7923303696c3b1c2873ba4b3706bd8ce172f0983f
...
Revert Action has already been performed; state remains DONE

0x42e49bbf524ac74e7296ffc4d0928ad60c1add011751fe97d55157365d76eac9

PASS

Historical replay, bound and injection tests

These tests used historical K2 while its gate was still LOCKED:
...
Replay exact K2 text immediately

Revert Rule already exists; attempt_count remains 1

0x59cf1364e48f3c52d7aadcd0516a9cf994b4f6d3842fd5f24bac6001b0315330

PASS

Submit a second distinct non-necessary rule

Accepted result recorded; attempt_count=2

0x3ad64786aab21d9b762d6f39c298cc01554a38151c355e7812e6aeb9b51190cc

PASS

Submit a third distinct rule

Revert Gate attempt limit reached; attempt_count=2

0x23a9313e9681e8d36a6634cb952887835342d2d7cc58c4ce95cba04341032881

PASS

Submit text containing </ACTION_LABEL> on a fresh gate

Revert Rule text contains a reserved prompt token; no attempt recorded

—

NOT RUN

Create a gate where actor equals creator

Revert Actor must be different from gate creator; no gate created
...
Record the full 66-character transaction hash and explorer /tx/ link.

Verify execution_result = SUCCESS for success cases or record the exact rollback for negative cases.

Read accepted contract state and record the exact postcondition.
